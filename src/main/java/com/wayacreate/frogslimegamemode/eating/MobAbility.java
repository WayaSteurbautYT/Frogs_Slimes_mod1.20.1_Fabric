...
public class MobAbility {
    ...
    static {
        ...
        register(new MobAbility("zombie", "Undead Strength", "Strength of the undead", 2.0, 0.0, 5.0, 0.1, AbilityType.LIFE_STEAL, 200));
        ...
        register(new MobAbility("cave_spider", "Toxic Bite", "Deadly venom", 2.0, 0.2, 0.0, 0.0, AbilityType.POISON_CLOUD, 180));
        ...
        register(new MobAbility("piglin", "Gold Greed", "Trading prowess", 1.0, 0.05, 0.0, 0.0, AbilityType.FIRE_RESISTANCE, 100));
        register(new MobAbility("warden", "Sonic Power", "Deep dark sensing", 8.0, 0.0, 20.0, 0.5, AbilityType.SONIC_BOOM, 400));
        register(new MobAbility("phantom", "Nightmare Flight", "Swooping terror", 2.0, 0.3, 0.0, 0.0, AbilityType.LEAP_ATTACK, 120));
        register(new MobAbility("drowned", "Depth Dweller", "Underwater strength", 2.5, 0.1, 8.0, 0.1, AbilityType.WATER_BREATH, 150));
        register(new MobAbility("husk", "Desert Hunger", "Thirst for life", 2.0, 0.0, 6.0, 0.1, AbilityType.LIFE_STEAL, 180));
        register(new MobAbility("stray", "Frozen Arrows", "Icy precision", 1.5, 0.1, 0.0, 0.0, AbilityType.ICE_SUMMON, 160));
        register(new MobAbility("wither_skeleton", "Wither Power", "Decaying strength", 4.0, 0.1, 10.0, 0.2, AbilityType.POISON_CLOUD, 250));
        ...
        register(new MobAbility("pillager", "Crossbow Mastery", "Ranged precision", 2.0, 0.05, 0.0, 0.0, AbilityType.PROJECTILE_SHOT, 140));
        ...
        register(new MobAbility("zoglin", "Undead Beast", "Corrupted fury", 4.5, 0.15, 12.0, 0.3, AbilityType.LIFE_STEAL, 230));
        register(new MobAbility("piglin_brute", "Brute Strength", "Raw power", 6.0, 0.1, 18.0, 0.4, AbilityType.SHIELD_BASH, 280));
        ...
        register(new MobAbility("cow", "Mighty Moo", "Dairy durability", 1.0, 0.0, 5.0, 0.1, AbilityType.HEALING, 150));
        ...
        register(new MobAbility("donkey", "Steady Carry", "Pack strength", 1.5, 0.1, 8.0, 0.2, AbilityType.NONE, 0));
        register(new MobAbility("mule", "Hybrid Power", "Best of both", 1.8, 0.15, 7.0, 0.2, AbilityType.NONE, 0));
        register(new MobAbility("llama", "Spit Attack", "Projectile defense", 1.0, 0.1, 6.0, 0.2, AbilityType.PROJECTILE_SHOT, 130));
        register(new MobAbility("trader_llama", "Merchant Guard", "Trading protection", 1.5, 0.1, 8.0, 0.2, AbilityType.THORNS, 180));
        ...
        register(new MobAbility("squid", "Ink Cloud", "Escape mechanism", 0.5, 0.2, 0.0, 0.0, AbilityType.INVISIBILITY, 90));
        register(new MobAbility("glow_squid", "Luminous Ink", "Glowing escape", 0.8, 0.25, 2.0, 0.0, AbilityType.INVISIBILITY, 100));
        register(new MobAbility("pufferfish", "Toxic Puff", "Poison defense", 0.3, 0.0, 1.0, 0.1, AbilityType.POISON_CLOUD, 80));
        ...
        register(new MobAbility("bee", "Stinging Fury", "Flying defender", 0.8, 0.3, 0.5, 0.0, AbilityType.POISON_CLOUD, 60));
        register(new MobAbility("axolotl", "Regeneration", "Healing power", 1.0, 0.15, 3.0, 0.0, AbilityType.HEALING, 120));
        register(new MobAbility("goat", "Head Bash", "Ramming power", 2.0, 0.2, 5.0, 0.2, AbilityType.SHIELD_BASH, 140));
        register(new MobAbility("panda", "Bamboo Strength", "Bear power", 2.5, 0.1, 8.0, 0.2, AbilityType.HEALING, 160));
        ...
        register(new MobAbility("allay", "Collection Joy", "Item gathering", 0.5, 0.4, 1.0, 0.0, AbilityType.SPEED_BOOST, 80));
        register(new MobAbility("frog", "Tongue Grab", "Quick strikes", 1.0, 0.2, 2.0, 0.0, AbilityType.LEAP_ATTACK, 90));
        register(new MobAbility("tadpole", "Growth Potential", "Future power", 0.3, 0.1, 0.5, 0.0, AbilityType.HEALING, 50));
        register(new MobAbility("warden", "Sonic Power", "Deep dark sensing", 8.0, 0.0, 20.0, 0.5, AbilityType.SONIC_BOOM, 400));
